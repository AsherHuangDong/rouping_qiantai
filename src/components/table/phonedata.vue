  ...
  export default {
      ...
      return {
        ...
        columns:[
          ...
          },
          {
            ...
            title: '邀请已实名人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.realName))
            }
          },
          {
            type: "center",
            ...
            title: '邀请未实名人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.noRealName))
            }
          },
          {
            align: "center",
            title: '邀请总人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.realName+params.row.noRealName))
            }
          },
          {
            align: "center",
            title: '注册人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.registerNum))
            }
          },
          {
            align: "center",
            title: '许愿人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.wishNum))
            }
          },
          {
            align: "center",
            title: '购买商品人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.shopNum))
            }
          },
          {
            align: "center",
            title: '收红包的人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.shouRedPacketNum))
            }
          },
          {
            align: "center",
            title: '发红包的人数',
            render: function (h, params) {
              return h('span',parseInt(params.row.faRedPacketNum))
            }
          },
         ],
        datezes:[]
    ...
    methods: {
      ...
      getData (){
        ...
        _this.$axios.post('/api/dataStat/queryPersonStat', _this.obj).then(res => {
