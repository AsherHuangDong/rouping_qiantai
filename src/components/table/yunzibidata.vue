  ...
  <div class="content_box">
    <div class="cont_head">
      <Breadcrumb :style="{padding: '14px 24px'}">
        ...
        <BreadcrumbItem>原子币统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="container">
      <Row>
        <Col >
          ...
          <div @click="dates" class="yangshi" style="display: initial;" >
  ...
  export default {
      ...
      return {
        ...
        columns:[
          ...
          },
          {
            ...
            title: '消费赠送的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.xiaoFeiZengSong))
            }
          },
          {
            type: "center",
            ...
            title: '邀请未实名人的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.yaoQingWeiShiMing))
            }
          },
          {
            align: "center",
            title: '邀请已实名人的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.yaoQingYiShiMing))
            }
          },
          {
            align: "center",
            title: '总邀请的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.yaoQingWeiShiMing+params.row.yaoQingYiShiMing))
            }
          },
          {
            align: "center",
            title: '邀请可以转发红包的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.jieSuoBuKeFaHongBao))
            }
          },
          {
            align: "center",
            title: '算力挖出的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.waBaoShouRu))
            }
          },
          {
            align: "center",
            title: '已经提现的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.yiJingTiXian))
            }
          },
          {
            align: "center",
            title: '实名未提现的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.shiMingWeiTiXian))
            }
          },
          {
            align: "center",
            title: '实名认证的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.shiMingJiangLi))
            }
          },
          {
            align: "center",
            title: '总计赠送的币',
            render: function (h, params) {
              return h('span',parseInt(params.row.xiaoFeiZengSong+params.row.yaoQingWeiShiMing+params.row.yaoQingYiShiMing+params.row.waBaoShouRu+params.row.shiMingJiangLi))
            }
          },
        ],
        datezes:[]
    ...
    methods: {
      ...
      getData (){
        ...
        _this.$axios.post('/api/dataStat/queryAtoshiStat', _this.obj).then(res => {
