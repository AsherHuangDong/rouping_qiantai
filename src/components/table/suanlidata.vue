  ...
  <div class="content_box">
    <div class="cont_head">
      <Breadcrumb :style="{padding: '14px 24px'}">
        ...
        <BreadcrumbItem>算力统计</BreadcrumbItem>
      </Breadcrumb>
    </div>
    <div class="container">
      <Row>
  ...
  export default {
      ...
      return {
        ...
        columns:[
          ...
          },
          {
            ...
            title: '未激活算力',
            render: function (h, params) {
              return h('span',params.row.unactivated)
            }
          },
          {
            type: "center",
            ...
            title: '激活算力',
            render: function (h, params) {
              return h('span',params.row.activate)
            }
          },
          {
            align: "center",
            title: '实名认证的算力',
            render: function (h, params) {
              return h('span',params.row.realNameCalculateStat)
            }
          },
          {
            align: "center",
            title: '消费获赠算力',
            render: function (h, params) {
              return h('span',params.row.consumptionPresent)
            }
          },
          {
            align: "center",
            title: '邀请算力(未激活)',
            render: function (h, params) {
              return h('span',params.row.inviteUnactivated)
            }
          },
          {
            align: "center",
            title: '邀请算力(已激活)',
            render: function (h, params) {
              return h('span',params.row.inviteActivated)
            }
          },
          {
            align: "center",
            title: '算力总计',
            render: function (h, params) {
              return h('span',params.row.activate+params.row.unactivated)
            }
          },
       ],
        datezes:[]
    ...
    methods: {
      ...
      getData (){
        ...
        _this.$axios.post('/api/dataStat/queryCalculatePowerStat', _this.obj).then(res => {
