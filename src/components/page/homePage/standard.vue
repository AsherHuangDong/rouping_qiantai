    ...
    <div style="background:rgba(255,255,255,1);">
      ...
      <div>
        <div
          ...
          v-for="(item,index) in inform.governmentStandardIPage.records"
          :key="index"
        >
          <div
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios
        .post("/api/governmentStandard/getAllGovernmentStandard", form)
        .then(res => {
          console.log(res);
          this.inform = res.data.data;
          this.total = res.data.data.governmentStandardIPage.total;
        });
    },
    changePage(page) {
    ...
    readAll() {
      this.$axios
        .post("/api/governmentStandard/updateAllGovernmentStandardRead")
        .then(res => {
          console.log(res);
          this.getData();
        });
