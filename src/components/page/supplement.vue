<template>
  <div
    style="background:rgba(247,248,250,1);display:flex;flex-direction:column;align-items:center;padding-top:72px;"
  >
    <div style="display:flex;flex-direction:column;align-items:flex-start">
      <div style="margin-bottom:23px">
        ...
        >请先填写完整信息，其中带星号*部分为必填项</span>
      </div>
      <div style="background:rgba(255,255,255,1);border-radius:4px;width:604px;padding-top:48px">
        <div>
          <div style>
